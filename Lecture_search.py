...
import time
# Importo las librer´´ias necesarias, pandas para manejar los datos y ykinter para hacer la interfaz básica que funciona
...
for index, row in df.iterrows():
    ht.insert(row["title"], df.loc[i])  #Uso el índice para llevar la cuenta de las filas que se van añadiendo y las voy añadiendo una a una.                 una,                                esto es lo que tarda mas de 
